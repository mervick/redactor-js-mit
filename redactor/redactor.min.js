...
this.opts.execCommandCallback(this,a);this.opts.air&&this.air.hide()}catch(h){}},execRun:function(a,b){"formatblock"===a&&this.browser("msie")&&(b="<"+b+">");this.document.execCommand(a,!1,b)},formatNewLine:function(a){a=this.getParentNode();if("DIV"===a.nodeName&&"redactor_editor"===a.className&&(a=b(this.getCurrentNode()),"DIV"===a.get(0).tagName&&(""===a.html()||"<br>"===a.html()))){var c=b("<p>").append(a.clone().get(0).childNodes);a.replaceWith(c);c.html("<br />");this.setSelection(c[0],0,c[0],
0)}},safariShiftKeyEnter:function(a,c){return a.shiftKey&&13===c?(a.preventDefault(),this.insertNodeAtCaret(b("<span><br /></span>").get(0)),this.syncCode(),!1):!0},formatEmpty:function(a){var c=b.trim(this.$editor.html());this.browser("mozilla")&&(c=c.replace(/<br>/i,""));var d=c.replace(/<(?:.|\n)*?>/gm,"");if(""===c||""===d)return a.preventDefault(),a=b(this.opts.emptyHtml).get(0),this.$editor.html(a),this.setSelection(a,0,a,0),this.syncCode(),!1;this.syncCode()},paragraphy:function(a){a=b.trim(a);
if(""===a||"<p></p>"===a)return this.opts.emptyHtml;this.opts.convertDivs&&(a=a.replace(/<div(.*?)>([\w\W]*?)<\/div>/gi,"<p>$2</p>"));var c=function(a,b,c){return a.replace(RegExp(b,"g"),c)},d=function(b,d){return c(a,b,d)};a+="\n";d("<br />\\s*<br />","\n\n");d("(<(table|thead|tfoot|caption|colgroup|tbody|tr|td|th|div|dl|dd|dt|ul|ol|li|pre|select|form|blockquote|address|math|style|script|object|input|param|p|h[1-6])[^>]*>)","\n$1");d("(</(table|thead|tfoot|caption|colgroup|tbody|tr|td|th|div|dl|dd|dt|ul|ol|li|pre|select|form|blockquote|address|math|style|script|object|input|param|p|h[1-6])>)",
...
this._moveBoundary(f.document,g,!1,d,e);this._moveBoundary(f.document,g,!0,a,b);return g.select()}if(f=this.getSelection())if(f.collapse&&f.extend)f.collapse(a,b),f.extend(d,e);else{r=this.document.createRange();r.setStart(a,b);r.setEnd(d,e);try{f.removeAllRanges()}catch(h){}f.addRange(r)}},getCurrentNode:function(){if("undefined"!==typeof this.window.getSelection)return this.getSelectedNode().parentNode;if("undefined"!==typeof this.document.selection)return this.getSelection().parentElement()},getParentNode:function(){return b(this.getCurrentNode()).parent()[0]},
...
"StartToStart":"StartToEnd",b)&&null!=a.previousSibling)););-1===e.compareEndPoints(d?"StartToStart":"StartToEnd",b)&&a.nextSibling?(e.setEndPoint(d?"EndToStart":"EndToEnd",b),b=a.nextSibling,d=e.text.length):(b=a.parentNode,d=this._getChildIndex(a));a.parentNode.removeChild(a);return[b,d]},_moveBoundary:function(a,b,d,e,f){var g,h,l;l=0;g=this._isText(e)?e:e.childNodes[f];h=this._isText(e)?e.parentNode:e;this._isText(e)&&(l=f);e=a.createElement("a");h.insertBefore(e,g||null);a=a.body.createTextRange();
a.moveToElementText(e);e.parentNode.removeChild(e);b.setEndPoint(d?"StartToStart":"EndToEnd",a);return b[d?"moveStart":"moveEnd"]("character",l)},_isText:function(a){return null!=a?3==a.nodeType:!1},_getChildIndex:function(a){for(var b=0;a=a.previousSibling;)b++;return b},insertNodeAfterCaret:function(a){this.saveSelection();this.insertNodeAtCaret(a);this.restoreSelection()},insertNodeAtCaret:function(a){if(this.window.getSelection){var b=this.getSelection();if(b.rangeCount){var d=b.getRangeAt(0);
...
e+'"><tbody></tbody></table>'),f=0;f<a;f++){for(var g=b("<tr></tr>"),h=0;h<c;h++){var l=b("<td><br></td>");b(g).append(l)}b(e).append(g)}b(d).append(e);a=b(d).html()+"<p></p>";this.restoreSelection();this.execCommand("inserthtml",a);this.modalClose();this.observeTables()},tableObserver:function(a){this.$table=b(a.target).closest("table");this.$table_tr=this.$table.find("tr");this.$table_td=this.$table.find("td");this.$tbody=b(a.target).closest("tbody");this.$thead=b(this.$table).find("thead");this.$current_td=
...
var a=b.proxy(function(){this.insert_link_node=!1;var a=this.getSelection(),d="",e="",f="";this.browser("msie")?(e=this.getParentNode(),"A"===e.nodeName?(this.insert_link_node=b(e),e=this.insert_link_node.text(),d=this.insert_link_node.attr("href"),f=this.insert_link_node.attr("target")):e=this.oldIE()?a.text:a.toString()):a&&a.anchorNode&&"A"===a.anchorNode.parentNode.tagName?(d=a.anchorNode.parentNode.href,e=a.anchorNode.parentNode.text,f=a.anchorNode.parentNode.target,""===a.toString()&&(this.insert_link_node=
a.anchorNode.parentNode)):e=a.toString();b(".redactor_link_text").val(e);a=self.location.href.replace(/\/$/i,"");a=d.replace(a,"");0===d.search("mailto:")?(this.setModalTab(2),b("#redactor_tab_selected").val(2),b("#redactor_link_mailto").val(d.replace("mailto:",""))):0===a.search(/^#/gi)?(this.setModalTab(3),b("#redactor_tab_selected").val(3),b("#redactor_link_anchor").val(a.replace(/^#/gi,""))):b("#redactor_link_url").val(a);"_blank"===f&&b("#redactor_link_blank").attr("checked",!0);b("#redactor_insert_link_btn").click(b.proxy(this.insertLink,
this));setTimeout(function(){b("#redactor_link_url").focus()},200)},this);this.modalInit(RLANG.link,this.opts.modal_link,460,a)},insertLink:function(){var a=b("#redactor_tab_selected").val(),c="",d="",e="";"1"===a?(c=b("#redactor_link_url").val(),d=b("#redactor_link_url_text").val(),b("#redactor_link_blank").attr("checked")&&(e=' target="_blank"'),a=/^\/(w+:{0,1}w*@)?(S+)(:[0-9]+)?(\/|\/([w#!:.?+=&%@!-/]))?\//i,-1==c.search(/^(http|ftp|https):\/\/\/(w+:{0,1}w*@)?(S+)(:[0-9]+)?(\/|\/([w#!:.?+=&%@!-/]))?\//i)&&
(0==c.search(a)&&!1!==this.opts.protocol)&&(c=this.opts.protocol+c)):"2"===a?(c="mailto:"+b("#redactor_link_mailto").val(),d=b("#redactor_link_mailto_text").val()):"3"===a&&(c="#"+b("#redactor_link_anchor").val(),d=b("#redactor_link_anchor_text").val());this._insertLink('<a href="'+c+'"'+e+">"+d+"</a>",b.trim(d),c,e)},_insertLink:function(a,c,d,e){this.$editor.focus();this.restoreSelection();""!==c&&(this.insert_link_node?(b(this.insert_link_node).text(c),b(this.insert_link_node).attr("href",d),""!==
e?b(this.insert_link_node).attr("target",e):b(this.insert_link_node).removeAttr("target"),this.syncCode()):this.execCommand("inserthtml",a));this.modalClose()},showFile:function(){this.saveSelection();var a=b.proxy(function(){var a=this.getSelection(),d="",d=this.oldIE()?a.text:a.toString();b("#redactor_filename").val(d);!1===this.opts.uploadCrossDomain&&!1===this.isMobile()&&b("#redactor_file").dragupload({url:this.opts.fileUpload,uploadFields:this.opts.uploadFields,success:b.proxy(this.fileUploadCallback,
this),error:b.proxy(this.opts.fileUploadErrorCallback,this)});this.uploadInit("redactor_file",{auto:!0,url:this.opts.fileUpload,success:b.proxy(this.fileUploadCallback,this),error:b.proxy(this.opts.fileUploadErrorCallback,this)})},this);this.modalInit(RLANG.file,this.opts.modal_file,500,a)},fileUploadCallback:function(a){this.restoreSelection();if(!1!==a){var c=b("#redactor_filename").val();""===c&&(c=a.filename);c='<a href="'+a.filelink+'">'+c+"</a>";this.browser("webkit")&&this.window.chrome&&(c+=
"&nbsp;");this.execCommand("inserthtml",c);"function"===typeof this.opts.fileUploadCallback&&this.opts.fileUploadCallback(this,a)}this.modalClose()},modalInit:function(a,c,d,e){0===b("#redactor_modal_overlay").size()&&(this.overlay=b('<div id="redactor_modal_overlay" style="display: none;"></div>'),b("body").prepend(this.overlay));this.opts.overlay&&(b("#redactor_modal_overlay").show(),b("#redactor_modal_overlay").click(b.proxy(this.modalClose,this)));0===b("#redactor_modal").size()&&(this.modal=
b('<div id="redactor_modal" style="display: none;"><div id="redactor_modal_close">&times;</div><div id="redactor_modal_header"></div><div id="redactor_modal_inner"></div></div>'),b("body").append(this.modal));b("#redactor_modal_close").click(b.proxy(this.modalClose,this));this.hdlModalClose=b.proxy(function(a){if(27===a.keyCode)return this.modalClose(),!1},this);b(document).keyup(this.hdlModalClose);this.$editor.keyup(this.hdlModalClose);0==c.indexOf("#")?b("#redactor_modal_inner").empty().append(b(c).html()):
b("#redactor_modal_inner").empty().append(c);b("#redactor_modal_header").html(a);"undefined"!==typeof b.fn.draggable&&(b("#redactor_modal").draggable({handle:"#redactor_modal_header"}),b("#redactor_modal_header").css("cursor","move"));if(0!==b("#redactor_tabs").size()){var f=this;b("#redactor_tabs a").each(function(a,c){a++;b(c).click(function(){b("#redactor_tabs a").removeClass("redactor_tabs_act");b(this).addClass("redactor_tabs_act");b(".redactor_tab").hide();b("#redactor_tab"+a).show();b("#redactor_tab_selected").val(a);
if(!1===f.isMobile()){var c=b("#redactor_modal").outerHeight();b("#redactor_modal").css("margin-top","-"+(c+10)/2+"px")}})})}b("#redactor_modal .redactor_btn_modal_close").click(b.proxy(this.modalClose,this));!1===this.isMobile()?(b("#redactor_modal").css({position:"fixed",top:"-2000px",left:"50%",width:d+"px",marginLeft:"-"+(d+60)/2+"px"}).show(),this.modalSaveBodyOveflow=b(document.body).css("overflow"),b(document.body).css("overflow","hidden")):b("#redactor_modal").css({position:"fixed",width:"100%",
height:"100%",top:"0",left:"0",margin:"0",minHeight:"300px"}).show();"function"===typeof e&&e();!1===this.isMobile()&&setTimeout(function(){var a=b("#redactor_modal").outerHeight();b("#redactor_modal").css({top:"50%",height:"auto",minHeight:"auto",marginTop:"-"+(a+10)/2+"px"})},20)},modalClose:function(){b("#redactor_modal_close").unbind("click",this.modalClose);b("#redactor_modal").fadeOut("fast",b.proxy(function(){b("#redactor_modal_inner").html("");this.opts.overlay&&(b("#redactor_modal_overlay").hide(),
b("#redactor_modal_overlay").unbind("click",this.modalClose));b(document).unbind("keyup",this.hdlModalClose);this.$editor.unbind("keyup",this.hdlModalClose)},this));!1===this.isMobile()&&b(document.body).css("overflow",this.modalSaveBodyOveflow?this.modalSaveBodyOveflow:"visible");return!1},setModalTab:function(a){b(".redactor_tab").hide();var c=b("#redactor_tabs a");c.removeClass("redactor_tabs_act");c.eq(a-1).addClass("redactor_tabs_act");b("#redactor_tab"+a).show()},uploadInit:function(a,c){this.uploadOptions=
{url:!1,success:!1,error:!1,start:!1,trigger:!1,auto:!1,input:!1};b.extend(this.uploadOptions,c);0!==b("#"+a).size()&&"INPUT"===b("#"+a).get(0).tagName?(this.uploadOptions.input=b("#"+a),this.element=b(b("#"+a).get(0).form)):this.element=b("#"+a);this.element_action=this.element.attr("action");this.uploadOptions.auto?b(this.uploadOptions.input).change(b.proxy(function(){this.element.submit(function(a){return!1});this.uploadSubmit()},this)):this.uploadOptions.trigger&&b("#"+this.uploadOptions.trigger).click(b.proxy(this.uploadSubmit,
this))},uploadSubmit:function(){this.uploadForm(this.element,this.uploadFrame())},uploadFrame:function(){this.id="f"+Math.floor(99999*Math.random());var a=this.document.createElement("div");a.innerHTML='<iframe style="display:none" id="'+this.id+'" name="'+this.id+'"></iframe>';b(a).appendTo("body");this.uploadOptions.start&&this.uploadOptions.start();b("#"+this.id).load(b.proxy(this.uploadLoaded,this));return this.id},uploadForm:function(a,c){if(this.uploadOptions.input){var d="redactorUploadForm"+
this.id,e="redactorUploadFile"+this.id;this.form=b('<form  action="'+this.uploadOptions.url+'" method="POST" target="'+c+'" name="'+d+'" id="'+d+'" enctype="multipart/form-data"></form>');!1!==this.opts.uploadFields&&"object"===typeof this.opts.uploadFields&&b.each(this.opts.uploadFields,b.proxy(function(a,c){0===c.toString().indexOf("#")&&(c=b(c).val());var d=b("<input/>",{type:"hidden",name:a,value:c});b(this.form).append(d)},this));var d=this.uploadOptions.input,f=b(d).clone();b(d).attr("id",e);
b(d).before(f);b(d).appendTo(this.form);b(this.form).css("position","absolute");b(this.form).css("top","-2000px");b(this.form).css("left","-2000px");b(this.form).appendTo("body");this.form.submit()}else a.attr("target",c),a.attr("method","POST"),a.attr("enctype","multipart/form-data"),a.attr("action",this.uploadOptions.url),this.element.submit()},uploadLoaded:function(){var a=b("#"+this.id)[0],a=a.contentDocument?a.contentDocument:a.contentWindow?a.contentWindow.document:window.frames[this.id].document;
this.uploadOptions.success&&("undefined"!==typeof a?(a=a.body.innerHTML.match(/\{(.|\n)*\}/)[0],a=b.parseJSON(a),"undefined"==typeof a.error?this.uploadOptions.success(a):(this.uploadOptions.error(this,a),this.modalClose())):(alert("Upload failed!"),this.modalClose()));this.element.attr("action",this.element_action);this.element.attr("target","")},browser:function(a){var b=navigator.userAgent.toLowerCase(),b=/(chrome)[ \/]([\w.]+)/.exec(b)||/(webkit)[ \/]([\w.]+)/.exec(b)||/(opera)(?:.*version|)[ \/]([\w.]+)/.exec(b)||
/(msie) ([\w.]+)/.exec(b)||0>b.indexOf("compatible")&&/(mozilla)(?:.*? rv:([\w.]+)|)/.exec(b)||[];return"version"==a?b[2]:"webkit"==a?"chrome"==b[1]||"webkit"==b[1]:b[1]==a},oldIE:function(){return this.browser("msie")&&9>parseInt(this.browser("version"),10)?!0:!1},outerHTML:function(a){return b("<p>").append(b(a).eq(0).clone()).html()},normalize:function(a){return parseInt(a.replace("px",""),10)},isMobile:function(a){return!0===a&&/(iPhone|iPod|iPad|BlackBerry|Android)/.test(navigator.userAgent)?
!0:/(iPhone|iPod|BlackBerry|Android)/.test(navigator.userAgent)?!0:!1}};b.fn.getObject=function(){return this.data("redactor")};b.fn.getEditor=function(){return this.data("redactor").$editor};b.fn.getCode=function(){return b.trim(this.data("redactor").getCode())};b.fn.getText=function(){return this.data("redactor").$editor.text()};b.fn.getSelected=function(){return this.data("redactor").getSelectedHtml()};b.fn.setCode=function(a){this.data("redactor").setCode(a)};b.fn.insertHtml=function(a){this.data("redactor").insertHtml(a)};
b.fn.destroyEditor=function(){this.each(function(){"undefined"!=typeof b(this).data("redactor")&&(b(this).data("redactor").destroy(),b(this).removeData("redactor"))})};b.fn.setFocus=function(){this.data("redactor").$editor.focus()};b.fn.execCommand=function(a,b){this.data("redactor").execCommand(a,b)}})(jQuery);
(function(b){function k(a,c){this.opts=b.extend({url:!1,success:!1,error:!1,preview:!1,uploadFields:!1,text:RLANG.drop_file_here,atext:RLANG.or_choose},c);this.$el=b(a)}b.fn.dragupload=function(a){return this.each(function(){(new k(this,a)).init()})};k.prototype={init:function(){if(-1===navigator.userAgent.search("MSIE")){this.droparea=b('<div class="redactor_droparea"></div>');this.dropareabox=b('<div class="redactor_dropareabox">'+this.opts.text+"</div>");this.dropalternative=b('<div class="redactor_dropalternative">'+
...
(function(b){var k=/(^|&lt;|\s)(www\..+?\..+?)(\s|&gt;|$)/g,a=/(^|&lt;|\s)(((https?|ftp):\/\/|mailto:).+?)(\s|&gt;|$)/g,c=function(){for(var d=this.childNodes,e=d.length;e--;){var f=d[e];if(3===f.nodeType){var g=f.nodeValue;g&&(g=g.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(k,'$1<a href="http://$2">$2</a>$3').replace(a,'$1<a href="$2">$2</a>$5'),b(f).after(g).remove())}else 1===f.nodeType&&!/^(a|button|textarea)$/i.test(f.tagName)&&c.call(f)}};b.fn.linkify=function(){this.each(c)}})(jQuery);
eval(function(b,k,a,c,d,e){d=function(a){return(a<k?"":d(parseInt(a/k)))+(35<(a%=k)?String.fromCharCode(a+29):a.toString(36))};if(!"".replace(/^/,String)){for(;a--;)e[d(a)]=c[a]||d(a);c=[function(a){return e[a]}];d=function(){return"\\w+"};a=1}for(;a--;)c[a]&&(b=b.replace(RegExp("\\b"+d(a)+"\\b","g"),c[a]));return b}('(5($){$.1.4.7={t:5(0,v){$(2).0("8",c);$(2).0("r",0);$(2).l(\'g\',$.1.4.7.b)},u:5(0){$(2).w(\'g\',$.1.4.7.b)},b:5(1){9 0=$(2).0("r");9 3=$.1.4.7.f(0).h();6(3!=\'\'){$(2).0("8",x);1.j="7";1.3=3;$.1.i.m(2,k)}},f:5(0){9 3=\'\';6(q.e){3=q.e()}o 6(d.e){3=d.e()}o 6(d.p){3=d.p.B().3}A 3}};$.1.4.a={t:5(0,v){$(2).0("n",0);$(2).0("8",c);$(2).l(\'g\',$.1.4.a.b);$(2).l(\'D\',$.1.4.a.s)},u:5(0){$(2).w(\'g\',$.1.4.a.b)},b:5(1){6($(2).0("8")){9 0=$(2).0("n");9 3=$.1.4.7.f(0).h();6(3==\'\'){$(2).0("8",c);1.j="a";$.1.i.m(2,k)}}},s:5(1){6($(2).0("8")){9 0=$(2).0("n");9 3=$.1.4.7.f(0).h();6((1.y=z)&&(3==\'\')){$(2).0("8",c);1.j="a";$.1.i.m(2,k)}}}}})(C);',
40,40,"data event this text special function if textselect textselected var textunselect handler false rdocument getSelection getSelectedText mouseup toString handle type arguments bind apply rttt else selection rwindow ttt handlerKey setup teardown namespaces unbind true keyCode 27 return createRange jQuery keyup".split(" "),0,{}));
